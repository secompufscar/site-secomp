...
class Usuario(db.Model):
    ...
    data_cadastro = Column(DateTime, default=strftime(http://sqlalche.me/e/gkpj"%Y-%m-%d %H:%M:%S", localtime(time())))
...
class Participante(db.Model):
    ...
    pacote = Column(Boolean, nullable=True, default=None)
    ...
    opcao_coffee = Column(Integer, nullable=True, default=None)
