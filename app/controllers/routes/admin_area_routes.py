...
@admin_area_routes.route('/area-administrativa/estoque-camisetas')
@login_required
...
@admin_area_routes.route('/area-administrativa/estoque-camisetas/<tamanho>')
@login_required
...
@admin_area_routes.route('/area-administrativa/cadastro-patrocinio', methods=['POST', 'GET'])
@login_required
...
@admin_area_routes.route('/area-administrativa/venda-kits', methods=['POST', 'GET'])
@login_required
def vender_kits():
...
@admin_area_routes.route('/area-administrativa/fazer-sorteio')
@login_required
def sortear():
    return render_template('sortear_usuario.html', sorteando=False)


@admin_area_routes.route('/area-administrativa/fazer-sorteio/do')
@login_required
def sorteando():
    # TODO: conferir permissões
...
@admin_area_routes.route('/area-administrativa/alterar-camiseta', methods=["GET", "POST"])
@login_required
