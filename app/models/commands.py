...
def populate():
    valores = {
        ...
        "diretorias": ["Coordenação Geral", "TI", "Design & Marketing", "Conteúdo", "Jurídico-Financeira", "Sóciocultural"],
    ...
    for camiseta in valores["camisetas"]:
        ...
        db.session.add(Camiseta(id=id, id_evento=1, ordem_site=id, tamanho=camiseta, quantidade=100, quantidade_restante=100))
        id += 1
